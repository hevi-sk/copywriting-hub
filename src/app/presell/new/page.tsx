...
export default function NewPresellPage() {
  ...
  async function handleFinalize() {
    ...
    toast({ title: 'Finalized', description: 'Presell page marked as finalized.' });
  }
  ...
  return (
    <div className="space-y-6">
      ...
      {step === 'setup' && (
        <div>
          <h1 className="text-2xl font-bold mb-6">New Presell Page</h1>
          <SetupForm
            type="presell"
      ...
      {step === 'generating' && (
        <div className="space-y-4">
          <h1 className="text-2xl font-bold">Generating Presell Page</h1>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold">
              {project.title || 'Edit Presell Page'}
            </h1>
